...
class IPTVDatabase:
    """IPTV veritabanı yönetim sınıfı - Flask bağımsız"""
...
# Flask SQLAlchemy modelleri (Flask uygulaması için)
try:
    ...
    # Flask SQLAlchemy mevcut değilse sadece temel sınıfları kullan
    print("Flask SQLAlchemy bulunamadı, sadece temel veritabanı sınıfları kullanılacak")
    db = None
    Category = None
    Channel = None
    WatchSession = None
